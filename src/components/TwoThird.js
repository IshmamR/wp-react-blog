		...
		<div className="w-full md:w-2/3 p-6 flex flex-col flex-grow flex-shrink">
			<div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
				<a href="#" className="flex flex-wrap no-underline hover:no-underline">
					<img src="https://source.unsplash.com/collection/169/800x600" className="h-64 w-full rounded-t pb-6 object-cover" />
					<p className="w-full text-gray-600 text-xs md:text-sm px-6">GETTING STARTED 1</p>

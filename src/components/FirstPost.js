...
const FirstPost = () => {
	return (
		<div className="FirstPost flex h-full bg-white rounded overflow-hidden shadow-lg">
			<a href="post.html" className="flex flex-wrap no-underline hover:no-underline">
				<div className="w-full md:w-2/3 rounded-t">	
					<img src="https://source.unsplash.com/collection/620/800x500" className="h-full shadow" />
				</div>

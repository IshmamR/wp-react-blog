...
const Nav = () => {
	return (
		<nav className="Nav mt-0 w-full">
			<div className="container mx-auto flex items-center">
				
				<div className="flex w-3/5 md:w-1/2 pl-4 items-center text-sm">
				...
				<div className="flex w-2/5 md:w-1/2 justify-end items-center content-center">		
